<template>
    <div class="basicMenu-page">
        <div class="search-box">
            ...
            <el-input v-model="searchData.parentId" placeholder="父级菜单id" style="width: 200px;" class="mr-20" />
            <el-input v-model="searchData.name" placeholder="名称" style="width: 200px;" class="mr-20" />
            <el-input v-model="searchData.router" placeholder="路由" style="width: 200px;" class="mr-20" />
            <el-input v-model="searchData.icon" placeholder="图标" style="width: 200px;" class="mr-20" />
            <el-input v-model="searchData.sort" placeholder="排序" style="width: 200px;" class="mr-20" />
            <el-input v-model="searchData.remark" placeholder="菜单说明" style="width: 200px;" class="mr-20" />
            <el-input v-model="searchData.createTime" placeholder="创建时间" style="width: 200px;" class="mr-20" />
            <el-input v-model="searchData.updateTime" placeholder="更新时间" style="width: 200px;" class="mr-20" />
        ...
        <el-dialog v-model="modelVisible" :title="modelTitle" width="30%"
                   ...
                   @closed="modelClosed"
        >
            <edit :id="basicMenuId" @success="addSuccess" v-if="modelVisible"/>
        </el-dialog>
    </div>
</template>
